				...
				<form action="admin_depe/query_dependencias.php" method="post" id ="formulario_agregar_dependencia" name ="formulario_agregar_dependencia" >
					<table border ="0">
						...
						<tr>
							...
							<td>
								<input type="text" placeholder="Digite Nombre de la dependencia" name="nombre_dependencia" id="nombre_dependencia" onkeyup="espacios_nombre_dependencia()" onblur="validar_grabar_dependencia()">
						...
						<tr>
							...
							<td>
								<input type="text" placeholder="Digite Dependencia Padre (Si tiene)" name="dependencia_padre" id="dependencia_padre" onkeyup="espacios_dependencia_padre()" >							
				...
				<form action="admin_depe/query_dependencias.php" method="post" id ="formulario_modificar_dependencia" name ="formulario_modificar_dependencia" >
					<table>
						<tr>
							...
							<input type="hidden" name ="tipo_formulario"id="tipo_formulario" value="2"><!--Valor 2 equivale a "Formulario de Modificación Dependencias" en query_dependencias.php-->
						...
						<tr>
							<td class="input_text">Nombre de la Dependencia :</td>
							<td>
								<input type="text" placeholder="Digite Nombre de la dependencia" name="mod_nombre_dependencia" id="mod_nombre_dependencia" onkeyup="espacios_mod_nombre_dependencia()">
								...
								<div id="error_mod_nombre_dependencia" class="errores">El nombre de la dependencia es obligatoria</div>
								...
								<div id="valida_maximo_mod_nombre" class="errores">El nombre de la dependencia no puede ser mayor a 40 caracteres (numeros o letras)</div>
							</td>
						</tr>
						<tr>
							<td class="input_text">Dependencia Padre :</td>
							<td>
								<input type="text" placeholder="Digite Dependencia Padre (Si tiene)" name="mod_dependencia_padre" id="mod_dependencia_padre" onkeyup="espacios_mod_dependencia_padre()" >							
...
<!--Hasta aqui el div que contiene el formulario para modificar Dependencia -->
		...
		<div class="form center">
				<input type="text" id="search_dependencias">
		</div>
